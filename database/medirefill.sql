...
('Dolo 650', 'Tablet', 120, '2027-08-15', 30, 25.00),

('Paracetamol', 'Tablet', 90, '2027-05-10', 15, 20.00),

('Amoxicillin 500mg', 'Capsule', 65, '2026-11-20', 10, 120.00),

('Insulin Injection', 'Injection', 25, '2026-09-30', 7, 450.00),

('Vitamin D3 Syrup', 'Syrup', 40, '2027-01-12', 20, 180.00),

('Shelcal 500', 'Tablet', 75, '2027-06-18', 30, 150.00),

('BP Monitor Strip', 'Medical Supply', 18, '2028-03-01', 60, 350.00),

('Omeprazole', 'Capsule', 80, '2027-02-22', 15, 95.00),

('Cough Syrup DX', 'Syrup', 30, '2026-12-14', 10, 110.00),

('Disposable Syringe', 'Medical Equipment', 150, '2029-01-01', 90, 15.00);
...
(1, 1, 30, 2, '2026-05-01', '2026-06-01'),
